...
import ItemAdicionado from "../../Components/Carrinho/ItemAdicionado";
import AdressInfoComponent from "../../Components/Carrinho/AdressComponent";
import RevisarComponent from "../../Components/Carrinho/RevisarPedidoComponent";
...
const CarrinhoComponent = () => {
  ...
  const [ExibirErroNoCarrinhoVazio, setExibirErroNoCarrinhoVazio] =
    useState(false);
  ...
  const MensagemNoWpp = () => {
    ...
    let mensagem = `${
      userData.length <= 0 ? "" : clienteIdentificado
  ...
  return (
    <div id="shoppingBAG" className="animate__animated animate__fadeIn ">
      <div
        className={`fixed top-0 bottom-0 left-0 right-0 sm:p-[50px] bg-colorBackground z-[9990] overflow-x-hidden overflow-y-auto overscroll-y-auto flex flex-col`}
        id="carrinho"
      >
        {/* HEADER DO CARRINHO */}
        <div className=" sm:pb-5" id="Headercar">
          <div className="sm:mx-[200px] mx-12 my-6">
            <Link
              className=" medium float-right bg-colorWhite shadow-xl p-2 rounded-xl hover:bg-colorPrimary"
              to="/home"
            >
              Fechar
            </Link>
            ...
            <div className="flex pb-5" id="1-2-3">
              {etapas.map((etapa, i) => (
                <div key={i}>
                  <div
                    className={`w-9 h-9 bg-colorWhite rounded-[50px] shadow-xl text-color21 flex justify-center items-center mr-[20px] ${
                      currentPg === i ? "primaria" : null
                    } `}
                  >
        ...
        {currentPg === 0 ? (
          <div id="Seu-Carrinho">
            ...
            {ExibirErroNoCarrinhoVazio ? (
              <div className="absolute sm:right-[41%] right-[15%] animate__animated animate__headShake bg-colorRed p-4 w-auto flex justify-center rounded-lg medium text-colorWhite">
                {" "}
        ...
        {currentPg === 1 ? (
          <>
            ...
            <AdressInfoComponent />
            {ExibirErroNoCep ? (
              <div className="absolute top-28 right-16 bg-red-400 p-2 rounded-xl text-colorWhite medium text-[20px] animate__animated animate__headShake">
                {" "}
                Insira um CEP válido{" "}
              </div>
            ) : null}
            {ExibirErroNoNumero ? (
              <div className="absolute top-28 right-28 bg-red-400 p-2 rounded-xl text-colorWhite medium text-[20px] animate__animated animate__headShake">
                {" "}
        ...
        <div className="sm:mx-[200px] flex flex-col w-min-max px-4 sm:px-0">
          <div className="  mb-4 pt-5 border-t border-colorSeparate">
            ...
            <div id="entrega" className="flex justify-end">
              <p
                className="mb-0 flex items-center text-colorSeparate medium text-[18px]"
                id="txt-entrega"
              >
            ...
            <div id="total" className="flex justify-end">
              <p
                className="mb-2 text-color21 text-xl mt-3 medium"
                id="txttotal"
              >
                <span>Total: </span>
                <span
            ...
            {currentPg === 0 ? (
              <button
                ...
                onClick={() => {
                  ...
                  carrinhoVazio
                    ? setExibirErroNoCarrinhoVazio(true)
              ...
              <button
                ...
                onClick={() => {
                  EnderecoDeEntrega.length <= 0
                    ? setExibirErroNoCep(true)
                    : EnderecoDeEntrega.numero === false
                    ? setExibirErroNoNumero(true)
                    : setCurrentPg(currentPg + 1);
                }}
              >
                Revisar pedido
            ...
            <button
              className={`mr-6 float-right bg-colorWhite p-3 rounded-xl medium text-[18px] text-color21 shadow-xl hover:bg-colorPrimary ${
                currentPg === 0 ? "hidden" : null
              }`}
              id="btn-back"
              onClick={() => {
